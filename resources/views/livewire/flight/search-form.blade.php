<div>
    ...
    <div class="col-lg-4">
        <label>Flying from</label>
        <input type="text" wire:model="from" class="form-control" placeholder="City or airport" />
        @error('from') <span class="text-danger small">{{ $message }}</span> @enderror
    </div>
    ...
    <div class="col-lg-4">
        <label>Flying to</label>
        <input type="text" wire:model="to" class="form-control" placeholder="City or airport" />
        @error('to') <span class="text-danger small">{{ $message }}</span> @enderror
    </div>
    ...
    <div class="col-lg-4">
        ...
        @error('departing') <span class="text-danger small">{{ $message }}</span> @enderror
    </div>
    ...
    @if ($tripType === 'round-trip')
        <div class="col-lg-4">
            <label>Returning</label>
            <input type="date" wire:model="returning" class="form-control" />
            @error('returning') <span class="text-danger small">{{ $message }}</span> @enderror
        </div>
    @endif
    ...
    <div class="col-lg-4">
        ...
        @error('adults') <span class="text-danger small">{{ $message }}</span> @enderror
    </div>
    ...
    <div class="col-lg-4">
        ...
        @error('infants') <span class="text-danger small">{{ $message }}</span> @enderror
    </div>
    ...
    <div class="col-lg-4">
        ...
        @error('cabinClass') <span class="text-danger small">{{ $message }}</span> @enderror
    </div>
