<div>
    ...
    <div class="container mt-5">
        ...
        <div class="row mt-4">
            @forelse($recommendedFlights as $flight)
                @php
                    // Determine lowest fare safely
                    $lowestFare = $flight->fares->sortBy('price_cents')->first();
                    // Use explicit flag set by service to know LLM influence
                ...
                <div class="col-md-6 mb-4">
                    <div class="card p-3 {{ $llmInfluenced ? 'border-info shadow-sm' : '' }}">
                        ...
                        <p>
                            ...
                            {{ number_format(optional($lowestFare)->price_cents / 100 ?? 0, 2) }}
                        </p>

                        <p>
                            <strong>Recommendation Score:</strong> {{ number_format($flight->score ?? 0, 2) }}
                            @if ($llmInfluenced)
                                <span class="badge bg-info ms-1">LLM Adjusted</span>
                            @endif
                        </p>
                        ...
                        <p>
                            ...
                            {{ $flight->reason ?: 'No reason provided' }}
                        </p>
